...
![Alt text](img/outputcatfile1.png)

cat < file2
## OUTPUT

![Alt text](img/outputcatfile2.png)

# Comparing Files
cmp file1 file2
## OUTPUT
 
![Alt text](img/CMPfile.png)

comm file1 file2
 ## OUTPUT

 ![Alt text](img/COMMfile.png)

diff file1 file2
## OUTPUT

![Alt text](img/difffile1.png)
...
![Alt text](img/f1-file22.png)

cut -d "|" -f 2 file22
## OUTPUT

![Alt text](img/f2-file22.png)
...
![Alt text](img/newfile-1.png)

grep hello newfile 
## OUTPUT

![Alt text](img/newfile-2.png)

grep -v hello newfile 
## OUTPUT

![Alt text](img/newfile-3.png)

cat newfile | grep -i "hello"
## OUTPUT

![Alt text](img/catfile-4.png)

cat newfile | grep -i -c "hello"
## OUTPUT

![Alt text](img/catfile-5.png)

grep -R ubuntu /etc
## OUTPUT

![Alt text](img/catfile-6.png)

grep -w -n world newfile   
## OUTPUT

![Alt text](img/catfile-7.png)
...
![Alt text](img/catfile-8.png)

egrep -w '(H|h)ello' newfile 
## OUTPUT

![Alt text](img/catfile-9.png)

egrep -w '(H|h)ell[a-z]' newfile 
## OUTPUT

![Alt text](img/catfile-10.png)

egrep '(^hello)' newfile 
## OUTPUT

![Alt text](img/catfile-11.png)

egrep '(world$)' newfile 
## OUTPUT

![Alt text](img/catfile-12.png)

egrep '(World$)' newfile 
## OUTPUT

![Alt text](img/catfile-13.png)

egrep '((W|w)orld$)' newfile 
## OUTPUT

![Alt text](img/catfile-19.png)

egrep '[1-9]' newfile 
## OUTPUT

![Alt text](img/catfile-14.png)

egrep 'Linux.*world' newfile 
## OUTPUT

![Alt text](img/catfile-15.png)

egrep 'Linux.*World' newfile 
## OUTPUT

![Alt text](img/catfile-16.png)

egrep l{2} newfile
## OUTPUT

![Alt text](img/catfile-17.png)

egrep 's{1,2}' newfile
## OUTPUT 

![Alt text](img/catfile-18.png)
